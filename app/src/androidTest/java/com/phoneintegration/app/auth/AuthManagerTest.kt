...
class AuthManagerTest {
    ...
    @Test
    fun `session timeout should be configured correctly`() {
    ...
    @Test
    fun `auth manager should be singleton`() {
    ...
    @Test
    fun `security settings should have reasonable defaults`() {
    ...
    @Test
    fun `activity tracking should work`() {
        // Update activity
