...
class SmsViewModel(app: Application) : AndroidViewModel(app) {
    ...
    private val CACHE_VALIDITY_MS = 30_000L // Cache valid for 30 seconds
    ...
    private suspend fun loadFromPersistentCacheInstantly() {
        ...
        try {
            ...
            if (cached.isNotEmpty()) {
                ...
                Log.d("SmsViewModel", "INSTANT: UI updated with cached data")
            } else {
    ...
    fun loadConversations(forceReload: Boolean = false) {
        viewModelScope.launch {
            ...
            // INSTANT: Show cached data if available
    ...
    fun loadConversation(address: String) {
        viewModelScope.launch {
            ...
            _conversationMessages.value = applyMmsOverrides(deduped)
    ...
    private fun applyMmsOverrides(messages: List<SmsMessage>): List<SmsMessage> {
