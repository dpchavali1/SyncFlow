 ...
 * 3. If no stored ID, generate from browser fingerprint + random UUID
...
/**
 * Generate a new device ID using browser fingerprint + random component
 */
...
async function generateBrowserFingerprint(): Promise<string> {
  ...
  components.push(generateRandomId());
